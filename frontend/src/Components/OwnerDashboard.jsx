    ...
    return (
        <div className="w-full min-h-screen bg-[#fff9f6] flex flex-col items-center">
            ...
            <div className="flex justify-center items-center p-4 sm:p-6">
                <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    <div className="flex flex-col items-center text-center ">
                        ...
                        <button className="bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-lg hover:bg-orange-600 transition-colors duration-200" onClick={()=>navigate("/create-edit-shop")}>
                            Get Started
                        </button>
                    </div>
                </div>
            ...
            <div className="w-full flex flex-col items-center gap-6 px-4 sm:px-6">
                ...
                <div className="bg-white shadow-lg rounded-xl overflow-hidden border border-orange-100 hover:shadow-2xl transitions-all duration-300 w-full max-w-3xl relative ">
                    ...
                    <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">{myShopData.name}</h1>
                ...
                <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6 border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                    <div className="flex flex-col items-center text-center ">
                        ...
                        <p className="text-gray-600 mb-4 text-sm sm:text-base ">Share Your delicious creations with out customers by adding them to the menu  </p>
                        <button className="bg-[#ff4d2d] text-white px-5 sm:px-6 py-2 rounded-full font-medium shadow-lg hover:bg-orange-600 transition-colors duration-200" onClick={()=>navigate("/add-item")}>
                            Add Food
                        </button>
                    </div>
                </div>
